    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0">Créer une collecte</h4>

                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item"><a href="{{route('admin_dashboard')}}">Tableau de bord</a></li>
                            <li class="breadcrumb-item active">Créer une collecte</li>
                        </ol>
                    </div>
        ...
        <div class="card">
            <div class="card-header">
                <h5>Créer une collecte</h5>
            </div>
            <form action="{{route('admin_dons_save')}}" method="POST" class="card-body">
                @csrf
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="mb-3">
                            ...
                            <input  type="text" value="{{old('title')}}"   name="title" id="" class="form-control" placeholder=""  />
                            @error('title')
                    ...
                    <div class="col-lg-4">
                        <div class="mb-3">
                            ...
                            <input  type="date" value="{{old('started')}}"   name="started" id="" class="form-control" placeholder=""  />
                            @error('started')
                            <small id="helpId" class="text-muted">{{$message}}</small>
                            @enderror
                        </div>
                    ...
                    <div class="col-lg-4">
                        <div class="mb-3">
                            ...
                            <input  type="date" value="{{old('finished')}}"   name="finished" id="" class="form-control" placeholder=""  />
                            @error('finished')
                            <small id="helpId" class="text-muted">{{$message}}</small>
                            @enderror
                        </div>
                    ...
                    <div class="col-lg-4">
                        <div class="mb-3">
                            ...
                            <input  type="text" value="{{old('cagnotte')}}"   name="cagnotte" id="" class="form-control" placeholder=""  />
                            @error('cagnotte')
                            <small id="helpId" class="text-muted">{{$message}}</small>
                            @enderror
                        </div>
                    ...
                    <div class="col-12 mt-3">
                        <div class="mb-3">
                            ...
                            <input  type="text" value="{{old('tags')}}"   name="tags" id="" class="form-control" placeholder=""  />
                            @error('tags')
                            <small id="helpId" class="text-muted">{{$message}}</small>
                            @enderror
