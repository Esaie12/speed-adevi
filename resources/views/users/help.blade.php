                        ...
                        <div class="mt-3">
                            <div class="d-flex align-items-center mb-2">
                                ...
                                <div class="flex-grow-1">
                                    <h5 class="fs-16 mb-0 fw-semibold">Questions générales</h5>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-4">
                        <div class="mt-3">
                            <div class="d-flex align-items-center mb-2">
                                ...
                                <div class="flex-grow-1">
                                    <h5 class="fs-16 mb-0 fw-semibold">Questions liées à votre compte</h5>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-4">
                        <div class="mt-3">
                            <div class="d-flex align-items-center mb-2">
                                ...
                                <div class="flex-grow-1">
                                    <h5 class="fs-16 mb-0 fw-semibold">Conditions et politiques</h5>
                                </div>
                            </div>
