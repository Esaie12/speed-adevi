        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0">Mes factures</h4>
                ...
                <div class="card" id="invoiceList">
                    <div class="card-header border-0">
                        <div class="d-flex align-items-center">
                            <h5 class="card-title mb-0 flex-grow-1">Mes factures</h5>
                            ...
                            <div class="table-responsive ">
                                <table class="table align-middle table-nowrap" id="example" style="width: 100%" >
                                    ...
                                    <tbody class="list form-check-all" id="exemple">
                                        ...
                                        <tr>
                                            <td class="id"><a href="{{route('user_invoice_show',encrypt($invoice->id))}}" class="fw-medium link-primary">#{{$invoice->reference}}</a></td>
                                            ...
                                            <td>
                                                <div class="dropdown">
                                                    ...
                                                    <ul class="dropdown-menu dropdown-menu-end" style="">
                                                        <li>
                                                            <a class="dropdown-item" href="{{route('user_invoice_show',encrypt($invoice->id))}}" ><i class="ri-eye-fill align-bottom me-2 text-muted"></i>
                                                                Voir la facture
                                                            </a>
                                                        </li>
                                                        <li>
