                        ...
                        <div class="dropdown ms-sm-3 header-item topbar-user">
                            ...
                            <div class="dropdown-menu dropdown-menu-end">
                                ...
                                <a class="dropdown-item" href="{{route('plateforme')}}"><i
                                        ...
                                        class="align-middle">Plateforme</span></a>
            ...
            <div id="scrollbar">
                <div class="container-fluid">
                    ...
                    <ul class="navbar-nav" id="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link menu-link" href="#monetisation" data-bs-toggle="collapse"
                                role="button" aria-expanded="false" aria-controls="sidebarDashboards">
                                <i class="ri-dashboard-2-line"></i> <span>Monétisation</span>
                            </a>
                            <div class="collapse menu-dropdown" id="monetisation">
                        ...
                        <li class="nav-item">
                            ...
                            <div class="collapse menu-dropdown" id="sidebarDashboards">
                                <ul class="nav nav-sm flex-column">
                                    <li class="nav-item">
                                        <a href="{{route('admin_category_index')}}" class="nav-link {{ $admin_category_index ?? '' }} " data-key="t-analytics">
                                           Catégorie</a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="{{route('admin_cursus_index')}}" class="nav-link {{ $admin_cursus_index ?? '' }} " data-key="t-analytics">
                                           Cursus</a>
                                    </li>
                        ...
                        <li class="nav-item">
                            <a class="nav-link menu-link" href="#userSide" data-bs-toggle="collapse"
                                role="button" aria-expanded="false" aria-controls="userSide">
                                <i class="ri-dashboard-2-line"></i> <span>Utilisateurs</span>
                            </a>
