...
<head>
    <title>{{ config('app.name', 'ADEVI') }}</title>
                    ...
                    <tr>
                        <td class="header" style="padding: 25px 0; text-align: center;">
                            <a href="{{ route('login') }}"
                                ...
                                <img width="130" src="{{ asset('assets/users/logo-light-2.png') }}""
                                    alt="{{ config('app.name', 'ADEVI') }}">
                            </a>
                        </td>
                    </tr>
                                ...
                                <tr>
                                    <td class="content-cell" align="center" style="max-width: 100vw; padding: 32px;">
                                        <p
                                            ...
                                            © {{ date('Y') }} {{ config('app.name', 'ADEVI') }}. All rights
                                            reserved.
                                        </p>
                                    </td>
                                </tr>
